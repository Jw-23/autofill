...
export const i18n = {
  zh: {
    ...
    enableEncryption: "启用安全模式",
    disableEncryption: "切换到普通模式 (解密敏感数据)",
    securityStatusOn: "当前状态：安全模式 (仅加密敏感数据) ✅",
    securityStatusOff: "当前状态：普通模式 (数据不加密) 🔓",
    closeBtn: "关闭",
    passReq: "主密码不能为空",
    passMatchError: "两次输入的密码不一致",
    resetData: "销毁数据并重置",
    resetConfirm: "确定要销毁所有数据并重置吗？此操作无法撤销！",
    enableConfirm: "切换到安全模式后，高敏感数据将被加密存储。确定吗？",
    disableConfirm: "确定要切换到普通模式吗？所有高敏感数据将变为明文存储。",
    encDone: "已切换到安全模式！",
    oneByOne: "逐个匹配模式",
    changePassBtn: "修改主密码",
    oldPass: "原主密码",
    newPass: "新主密码",
    confirmNewPass: "确认新主密码",
    passChangeSuccess: "密码修改成功！",
    invalidOldPass: "原密码不正确，请重试。",
    clusterMode: "集群识别模式",
    dataManagement: "数据管理",
    ...
    floatingPrompt: "随手记提示框",
    floatingPromptDesc: "当输入框获得焦点时，在上方显示 AI 写提示词的随手记小框。",
    ...
    confirmBtn: "确定",
    AISettingTitle: "AI 设置",
    aiProvider: "AI 模型提供商",
    aiProviderLocal: "本地模型 (Gemini Nano, 隐私安全)",
    aiProviderRemote: "远程 API (OpenAI 等, 需配置)",
    aiRemoteDesc: "⚠️ 隐私提示：使用远程 API 时，页面输入框的上下文信息会被发送到第三方服务器进行分析，但您的密码库敏感值（Value）**绝不会**被发送。仅发送表单标签和您在“仓库”中配置的“描述(Description)”字段用于语义匹配。",
    aiBaseUrl: "API 基础 URL (Base URL)",
    aiKey: "API 密钥 (Key)",
    aiModel: "模型名称",
    ...
    fetchError: "获取失败",
    fetchSuccess: "成功获取模型",
    enterKeyUrl: "请先填写 URL 和 Key",
    smartAddBtn: "✨ 智能添加",
    smartAddModalTitle: "AI 智能添加",
    smartAddDesc: "描述您想添加的数据（例如“添加我的收货地址...”）。AI 将自动为您结构化数据。",
    smartAddPlaceholder: "例如：生成一个名为 Alex 的开发人员档案，居住在旧金山，邮箱是 alex@example.com...",
    smartAddGenerate: "生成",
    smartAddPreviewTitle: "预览生成数据",
    smartAddConfirm: "添加选中项",
    smartAddGenerating: "正在生成...",
    smartAddError: "生成失败，请检查 API 设置并确保使用支持 JSON 输出的模型。",
    smartAddNoResult: "未生成有效数据，请尝试更详细的描述。"
  },
  en: {
    ...
    enableEncryption: "Enable Security Mode",
    disableEncryption: "Switch to Normal Mode (Decrypt Secrets)",
    securityStatusOn: "Status: Security Mode (Only secrets encrypted) ✅",
    securityStatusOff: "Status: Normal Mode (No encryption) 🔓",
    closeBtn: "Close",
    ...
    enableConfirm: "Switching to Security Mode will encrypt your high-sensitivity data. Continue?",
    disableConfirm: "Are you sure you want to switch to Normal Mode? All sensitive items will be decrypted.",
    encDone: "Switched to Security Mode!",
    ...
    invalidOldPass: "Incorrect old password. Please try again.",
    ...
    floatingPrompt: "Floating Prompt",
    floatingPromptDesc: "Show AI prompt box on input focus.",
    ...
    aiRemoteDesc: "⚠️ Privacy Note: When using Remote API, form context is sent to the third-party server. However, your sensitive vault values are **NEVER** sent. Only form labels and your vault 'Descriptions' are sent for semantic matching.",
